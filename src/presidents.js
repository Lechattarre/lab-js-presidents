...
function getNames(presidentsArr) {
  const namesArray = presidentsArr.map(eachPresident => {
...
function getDemocraticPresidents(presidentsArr) {
  const democraticPre = presidentsArr.filter(eachPresident => {
    return eachPresident.party && eachPresident.party.toLowerCase() === 'democratic';
  });


  return democraticPre;
}
...
function countYearsInOffice(presidentsArr) {
  const totalYears = presidentsArr.reduce((acc, eachPresident) => {

    if (eachPresident.tookOffice === null || eachPresident.leftOffice === null) {
      return acc
    }

    const yearsInOffice = eachPresident.leftOffice - eachPresident.tookOffice
...
// const newPresidentArr = presidentsArr.map(eachPresident => {
